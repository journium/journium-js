#!/bin/bash
# Test @journium/angular compatibility with Angular 17.x

set -e

echo "Testing @journium/angular with Angular 17.x..."
...
# Create package.json with Angular 17.x
cat > package.json <<'PKGJSON'
{
  "name": "angular-17-compat-test",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "test": "jest"
...
echo "Installing Angular 17.x and dependencies..."
cd "$TEST_DIR"
...
echo "Angular 17.x compatibility test passed!"

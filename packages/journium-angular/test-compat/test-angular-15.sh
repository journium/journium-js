#!/bin/bash
# Test @journium/angular compatibility with Angular 15.x

set -e

echo "Testing @journium/angular with Angular 15.x..."
...
# Create package.json with Angular 15.x
cat > package.json <<'PKGJSON'
{
  "name": "angular-15-compat-test",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "test": "jest"
...
echo "Installing Angular 15.x and dependencies..."
cd "$TEST_DIR"
...
echo "Angular 15.x compatibility test passed!"

#!/bin/bash
# Test @journium/angular compatibility with Angular 19.x

set -e

echo "Testing @journium/angular with Angular 19.x..."
...
# Create package.json with Angular 19.x
cat > package.json <<'PKGJSON'
{
  "name": "angular-19-compat-test",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "test": "jest"
...
echo "Installing Angular 19.x and dependencies..."
cd "$TEST_DIR"
...
echo "Angular 19.x compatibility test passed!"

#!/bin/bash
# Test @journium/react compatibility with React 17.0.2

set -e

echo "🧪 Testing @journium/react with React 17.0.2..."
...
# Create package.json with React 17.0.2
cat > package.json <<EOF
{
  "name": "react-17-compat-test",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "test": "jest"
...
echo "📥 Installing React 17.0.2 and dependencies..."
cd "$TEST_DIR"
...
echo "✅ React 17.0.2 compatibility test passed!"
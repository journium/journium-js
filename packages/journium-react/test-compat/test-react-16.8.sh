#!/bin/bash
# Test @journium/react compatibility with React 16.8.0 (minimum supported version)

set -e

echo "🧪 Testing @journium/react with React 16.8.0..."
...
# Create package.json with React 16.8.0
cat > package.json <<EOF
{
  "name": "react-16.8-compat-test",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "test": "jest"
...
echo "✅ React 16.8.0 compatibility test passed!"

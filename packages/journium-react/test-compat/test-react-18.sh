#!/bin/bash
# Test @journium/react compatibility with React 18.x

set -e

echo "🧪 Testing @journium/react with React 18.x..."
...
# Create package.json with React 18.x
cat > package.json <<EOF
{
  "name": "react-18-compat-test",
  "version": "1.0.0",
  "private": true,
  "scripts": {
    "test": "jest"
...
echo "✅ React 18.x compatibility test passed!"
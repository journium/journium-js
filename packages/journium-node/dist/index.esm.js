import { fetchRemoteConfig, generateUuidv7, getCurrentTimestamp, generateId } from '@journium/shared';
    ...
    async initialize() {
        ...
        try {
            if (this.config.applicationKey) {
                ...
                const remoteConfigResponse = await fetchRemoteConfig(this.config.apiHost, this.config.applicationKey, this.config.configEndpoint, fetch);
...
export { JourniumNodeClient, index as default, init };
